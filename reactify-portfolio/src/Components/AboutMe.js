                ...
                <section className="site-section" id="about-section">
                    <div className="container">
                        ...
                        <div className="col-lg-7 pr-lg-5 mb-5 mb-lg-0">
                            <img src="images/IMG_20190628_005911_133.jpg" alt="mypic" className="img-fluid" />
                        </div>
                        <div className="col-lg-5 pl-lg-5">
                            <div className="section-heading">
                            <h2>About <strong>Me</strong></h2>
                            </div>
                            <p className="lead">Born in 1997 to become a computer engineer in modern world from Mymensing,Bangladesh.</p>
                            <p className="mb-5  ">Since I began my professional journey I’ve been lucky to have had the opportunity to collaborate on some exciting solo and collaborative projects. I take pride in all that I do and in the long-term relationships I’ve fostered in the process. I firmly believe that hard work eventually pays off, and I know that each day brings me closer to reaching my goals. Explore my portfolio, and feel free to get in touch with any questions.</p>

                            <p>
                            <a href="#section-contact" className="btn btn-primary px-4 py-2 btn-sm smoothscroll">Contact me</a>
                            <a href="/" className="btn btn-secondary px-4 py-2 btn-sm">Show CV</a>
                            </p>
                        </div>
                        </div>
                        ...
                        <div className="col-md-9">
                            ...
                            <div className="progress">
                                <div className="progress-bar" id="design" role="progressbar" style={{width: '85%'}} aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">
                                <span>85%</span>
                                </div>
                            </div>
                            </div>
